...
class _EnterTurnOverPageWidgetState extends State<EnterTurnOverPageWidget> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ChargeService>(builder: (context, chargeService, child) {
      return Scaffold(
        appBar: AppBar(),
        floatingActionButton: SizedBox(
            ...
            child: FloatingActionButton.extended(
                ...
                onPressed: () {
                  PostPoint _point = PostPoint(
                    memberKeyId: 3,
                    addPoint: int.tryParse(phoneNumber),
                    type: "PLUS",
                  );
                  chargeService.plusPoint(_point);
                },
                label: Container(
